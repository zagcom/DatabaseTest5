...
namespace DatabaseTest5
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DatabaseTest5Context>(options =>
                    options.UseSqlServer(
                        Configuration.GetConnectionString("DatabaseTest5ContextConnection")));
        ...
        private async Task CreateRoles(IServiceProvider serviceProvider)
        {
            ...
            DatabaseTest5User user = await UserManager.FindByEmailAsync("admin@zagcom.pl");
